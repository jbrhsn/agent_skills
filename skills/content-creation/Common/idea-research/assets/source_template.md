...
> Raw thoughts and research. This is the SOURCE file — the Medium article, LinkedIn post, and Reddit post all get derived from here. Write messy, write more than you need, cut later.

- **Topic:** {topic}
- **Beat:** {beat}
- **Primary platform:** {platform}
- **Created:** {date} (from `{idea_id}`, score {score}/100)
...
What already exists on Medium and LinkedIn, and what it misses. If several strong recent pieces exist, either find a sharper angle or drop this.
