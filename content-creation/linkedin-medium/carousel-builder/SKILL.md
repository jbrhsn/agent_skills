...
Design spec:
```
python3 .opencode/skills/carousel-builder/scripts/spec.py \
  linkedin/carousels/<slug>/slides.json \
  --path linkedin/carousels/<slug> --render svg
```
SVG preview:
```
python3 .opencode/skills/carousel-builder/scripts/render_svg.py \
  linkedin/carousels/<slug>/slides.json \
  --out linkedin/carousels/<slug> --only 1
```
HTML path (add `--template templates/slide-<theme>.html` for a themed look; omit for the default dark style):
```
python3 .opencode/skills/carousel-builder/scripts/render_html.py \
  linkedin/carousels/<slug>/slides.json \
  --out linkedin/carousels/<slug> \
  --template .opencode/skills/carousel-builder/templates/slide-neon.html \
  --only 1
```
...
```
python3 .opencode/skills/carousel-builder/scripts/svg_to_png.py \
